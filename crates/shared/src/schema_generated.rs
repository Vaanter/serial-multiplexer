...
pub mod serial_multiplexer {
  ...
  pub fn root_as_datagram(buf: &[u8]) -> Result<Datagram<'_>, flatbuffers::InvalidFlatbuffer> {
  ...
  pub fn size_prefixed_root_as_datagram(
    buf: &[u8],
  ) -> Result<Datagram<'_>, flatbuffers::InvalidFlatbuffer> {
  ...
  pub unsafe fn root_as_datagram_unchecked(buf: &[u8]) -> Datagram<'_> {
  ...
  pub unsafe fn size_prefixed_root_as_datagram_unchecked(buf: &[u8]) -> Datagram<'_> {
